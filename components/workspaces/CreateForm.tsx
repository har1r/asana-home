...
import { ArrowLeft, AlertTriangle, CheckCircle, Phone, Plus, Trash2, Check } from 'lucide-react';
...
export const CreateForm: React.FC<CreateFormProps> = React.memo(({ onSuccess, onCancel, initialData }) => {
  ...
  useEffect(() => {
    if (initialData) {
      try {
        ...
        setSuccess('Draf permohonan berhasil diduplikat untuk form baru!');
    ...
    try {
      ...
      if (stored) {
        ...
        setSuccess('Draf pengisian sebelumnya berhasil dipulihkan!');
        setTimeout(() => setSuccess(''), 2500);
      }
    } catch (e) {
  ...
  return (
    <div className="w-full bg-transparent animate-fadeIn">
      ...
      <div className="w-full bg-white rounded-3xl border border-slate-200/60 shadow-sm flex flex-col overflow-hidden">


        {/* Stepper Indicator Navigation */}
        {steps.length > 1 && (
              ...
              {steps.map((step, idx) => {
                ...
                return (
                  <div key={step.label} className="flex flex-col items-center gap-1.5 z-10 bg-slate-50 px-3 rounded-lg">
                    ...
                    <span className={`text-[9px] font-extrabold capitalize tracking-wider hidden sm:inline-block ${isActive ? 'text-[#2c333f]' : isCompleted ? 'text-emerald-600' : 'text-slate-400'
                      }`}>
                      {step.label}
                    </span>
                  </div>
        ...
        <div className="p-6 sm:p-8 flex flex-col gap-6">
          ...
          <form onSubmit={handleCreate} className="flex flex-col gap-6">
            ...
            {currentStepLabel === 'Data Utama' && (
              <div className="flex flex-col gap-5 p-6 rounded-2xl bg-[#f3f6f9] shadow-3xs animate-fadeIn">
                <div className="flex items-center text-indigo-600 font-extrabold text-[11px] capitalize tracking-wider border-b border-slate-100 pb-2 select-none mb-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      disabled={loading}
                      className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-bold text-gray-800 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs cursor-pointer"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-805 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.nomorPelayanan ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-bold text-gray-805 font-mono focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.nop ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className={`flex items-center bg-white border rounded-xl overflow-hidden shadow-3xs transition-all focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 ${formErrors.noWhatsapp ? 'border-red-500' : 'border-slate-200'
                      }`}>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-805 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.tanggalNoPelayanan ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.tanggalPenyelesaian ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                    />
            ...
            {currentStepLabel === 'Data Lama (Asal)' && needDataLama && (
              <div className="flex flex-col gap-5 p-6 rounded-2xl bg-[#f3f6f9] shadow-3xs animate-fadeIn">
                <div className="flex items-center text-indigo-600 font-extrabold text-[11px] capitalize tracking-wider select-none border-b border-slate-100 pb-2 mb-1">
                  <span>2. Data Lama (Asal)</span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-1.5 sm:col-span-2">
                    ...
                    <input
                      ...
                      style={{ textTransform: 'uppercase' }}
                      disabled={loading}
                      className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-bold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.namaPemilikLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                    />
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          style={{ textTransform: 'uppercase' }}
                          disabled={loading}
                          className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.alamatPemilikLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        />
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          style={{ textTransform: 'uppercase' }}
                          disabled={loading}
                          className={`w-full bg-white border rounded-xl px-3.5 py-2 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.kecamatanPemilikLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        />
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          style={{ textTransform: 'uppercase' }}
                          disabled={loading}
                          className={`w-full bg-white border rounded-xl px-3.5 py-2 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.desaPemilikLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        />
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          style={{ textTransform: 'uppercase' }}
                          disabled={loading}
                          className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.alamatObjekLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        />
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <select
                          ...
                          disabled={loading}
                          className={`w-full bg-white border rounded-xl px-3 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs cursor-pointer ${formErrors.kecamatanObjekLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        >
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <select
                          ...
                          className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold transition-all text-gray-755 focus:outline-none focus:border-indigo-500 shadow-3xs cursor-pointer ${formErrors.desaObjekLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                        >
                          <option value="">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        disabled={loading}
                        className={`w-full bg-white border rounded-xl pl-3.5 pr-10 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.luasTanahLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                      />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        disabled={loading}
                        className={`w-full bg-white border rounded-xl pl-3.5 pr-10 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.luasBangunanLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                      />
                      <span className="text-slate-400 text-[10px] font-bold absolute right-3.5 top-1/2 -translate-y-1/2 select-none">
                        m²
                      </span>
                  ...
                  <div className="flex flex-col gap-1.5 sm:col-span-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        style={{ textTransform: 'uppercase' }}
                        disabled={loading}
                        className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-755 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors.sertifikatLama ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                      />
            ...
            {currentStepLabel === 'Data Baru' && needDataBaru && (
              <div className="flex flex-col gap-4 p-5 rounded-2xl bg-[#f3f6f9] shadow-3xs animate-fadeIn">
                <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-1 select-none">
                  <h4 className="text-[11px] font-extrabold text-indigo-600 capitalize tracking-wider">3. Data Baru</h4>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-1.5 sm:col-span-2">
                          ...
                          <input
                            ...
                            style={{ textTransform: 'uppercase' }}
                            disabled={loading}
                            className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-bold text-gray-805 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.namaPemilikBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                          />
                          ...
                          <div className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  style={{ textTransform: 'uppercase' }}
                                  disabled={loading}
                                  className={`w-full bg-white border rounded-xl pl-3.5 pr-20 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.alamatPemilikBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                                />
                                {needDataLama && (
                                  <button
                                    type="button"
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                style={{ textTransform: 'uppercase' }}
                                disabled={loading}
                                className={`w-full bg-white border rounded-xl px-3.5 py-2 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.kecamatanPemilikBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                              />
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                style={{ textTransform: 'uppercase' }}
                                disabled={loading}
                                className={`w-full bg-white border rounded-xl px-3.5 py-2 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.desaPemilikBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                              />
                          ...
                          <div className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  style={{ textTransform: 'uppercase' }}
                                  disabled={loading}
                                  className={`w-full bg-white border rounded-xl pl-3.5 pr-20 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.alamatObjekBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                                />
                                {needDataLama && (
                                  <button
                                    type="button"
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <select
                                ...
                                disabled={loading}
                                className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs cursor-pointer ${formErrors[`dataBaru.${idx}.kecamatanObjekBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                              >
                                <option value="">Pilih Kecamatan Objek</option>
                                {Object.keys(KECAMATAN_DATA).map(kec => (
                                  <option key={kec} value={kec}>{kec}</option>
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <select
                                ...
                                className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold transition-all text-gray-855 focus:outline-none focus:border-indigo-500 shadow-3xs cursor-pointer ${formErrors[`dataBaru.${idx}.desaObjekBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                              >
                                <option value="">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <div className="relative">
                            <input
                              ...
                              disabled={loading}
                              className={`w-full bg-white border rounded-xl pl-3.5 pr-10 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.luasTanahBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                            />
                            <span className="text-slate-400 text-[10px] font-bold absolute right-3.5 top-1/2 -translate-y-1/2 select-none">
                              m²
                            </span>
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <div className="relative">
                            <input
                              ...
                              disabled={loading}
                              className={`w-full bg-white border rounded-xl pl-3.5 pr-10 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.luasBangunanBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                            />
                            <span className="text-slate-400 text-[10px] font-bold absolute right-3.5 top-1/2 -translate-y-1/2 select-none">
                              m²
                            </span>
                        ...
                        <div className="flex flex-col gap-1.5 sm:col-span-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              style={{ textTransform: 'uppercase' }}
                              disabled={loading}
                              className={`w-full bg-white border rounded-xl px-3.5 py-2.5 text-xs font-semibold text-gray-855 focus:outline-none focus:border-indigo-500 transition-all shadow-3xs ${formErrors[`dataBaru.${idx}.sertifikatBaru`] ? 'border-red-500 focus:border-red-500' : 'border-slate-200'}`}
                            />
              ...
              <div>
                ...
                {formProgress.filled === formProgress.total ? (
                  ...
                  <span className="text-[9px] font-extrabold text-slate-400">
                    {formProgress.total - formProgress.filled} kolom masih kosong
                  </span>
                )}
              </div>
              <div className="flex items-center gap-3">
                ...
                {currentStep < steps.length ? (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="bg-gradient-to-br from-[#7dd4fc] via-[#9cb4fe] to-[#cab3fe] hover:opacity-90 text-[#2c333f] font-bold text-xs capitalize tracking-wider py-2.5 px-6 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                  >
                    {loading ? (
