...
/** Skeleton presisi untuk List View DataEntryWorkspace (tab=my-tasks) */
export function DataEntryListSkeleton() {
  return (
...
export function DataEntryCreateSkeleton() {
  return (
...
// Aliases untuk backward compatibility jika dibutuhkan
export const PenginputListSkeleton = DataEntryListSkeleton;
export const PenginputCreateSkeleton = DataEntryCreateSkeleton;
