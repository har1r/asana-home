                        ...
                        {steps.map((step, idx) => {
                            ...
                            return (
                                <React.Fragment key={step.label || idx}>
                                    {idx > 0 && (
                                        <div
                                            className={`flex-1 h-0.5 mt-3.5 sm:mt-4 transition-all duration-300 ${isCompleted ? 'bg-[#00a389]' : 'bg-slate-200/80'
                                                }`}
                                        />
                                    )}
                                    <button
                                    ...
                                    >
                                        <div
                                            className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-200 ${isCompleted
                                        ...
                                        <span
                                            className={`text-[12px] sm:text-[13px] transition-colors font-sans whitespace-nowrap ${isCompleted
