                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 font-sans">
                                ...
                                <div className="flex flex-col gap-1.5 sm:col-span-2">
                                    ...
                                    <input type="text" id={`targetData.${idx}.ownerName`} placeholder="BUDI SANTOSO" value={item.ownerName} onChange={(e) => onTargetItemChange(idx, 'ownerName', e.target.value.toUpperCase())} style={{ textTransform: 'uppercase' }} disabled={loading} className={getInputClass(!!formErrors[`targetData.${idx}.ownerName`])} />
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        ...
                                        <div className="flex flex-col gap-1"><label className="text-[13px] font-normal text-slate-700 font-sans">RT <span className="text-slate-400 text-xs">(Opsional)</span></label><input type="text" placeholder="002" value={item.objectRt} onChange={(e) => onTargetItemChange(idx, 'objectRt', e.target.value)} disabled={loading} className={getInputClass()} /></div>
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="relative"><input type="number" id={`targetData.${idx}.landArea`} placeholder="200" value={item.landArea} onChange={(e) => onTargetItemChange(idx, 'landArea', e.target.value)} disabled={loading} className={getInputClass(!!formErrors[`targetData.${idx}.landArea`], 'pl-3.5 pr-10')} /><span className="text-slate-500 text-xs absolute right-3.5 top-1/2 -translate-y-1/2 select-none font-sans">m²</span></div>
                                    {formErrors[`targetData.${idx}.landArea`] && <span className="text-xs text-red-600 pl-1 mt-0.5">{formErrors[`targetData.${idx}.landArea`]}</span>}
                                </div>
