    ...
    try {
      ...
      if (selectedBundle?.id) {
        ...
        if (detailRes.success && 'bundle' in detailRes && detailRes.bundle) {
          ...
          setPermohonanList((detailRes.bundle as any).applications || (detailRes.bundle as any).permohonan || []);
        }
      }
    } catch (err: any) {
  ...
  const fetchBundleDetail = useCallback(async (bundleId: string) => {
    try {
      ...
      if (res.success && 'bundle' in res && res.bundle) {
        ...
        setPermohonanList((res.bundle as any).applications || (res.bundle as any).permohonan || []);
      } else {
