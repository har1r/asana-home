        ...
        if (selectedManifest) {
          ...
          if (detailRes.success && 'manifest' in detailRes && detailRes.manifest) {
            ...
            if (selectedBundleInManifest) {
              const bundleList = (detailRes.manifest as any).bundles || (detailRes.manifest as any).bundle || [];
              const updatedBundle = bundleList.find((b: any) => b.id === selectedBundleInManifest.id);
