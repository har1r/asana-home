...
export interface SenderBundleCardHistoryProps {
  bundle: any;
  isSelected: boolean;
...
export const SenderBundleCardHistory: React.FC<SenderBundleCardHistoryProps> = React.memo(({
  bundle,
  isSelected,
  ...
  return (
    <div
      ...
      className={`p-3 sm:p-3.5 rounded-md border flex flex-col justify-between gap-2.5 transition-all duration-300 hover:-translate-y-0.5 cursor-pointer relative overflow-hidden group select-none min-h-[145px] font-sans ${
        isSelected
    ...
    >
      ...
      {/* Bottom Row: Peneliti Avatar & Creation Date */}
...
SenderBundleCardHistory.displayName = "SenderBundleCardHistory";
