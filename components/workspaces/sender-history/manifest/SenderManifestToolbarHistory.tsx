...
interface SenderManifestToolbarHistoryProps {
  searchQuery: string;
...
export const SenderManifestToolbarHistory: React.FC<SenderManifestToolbarHistoryProps> = React.memo(({
  searchQuery,
  onSearchChange,
  onSearchSubmit,
  onClearSearch,
...
SenderManifestToolbarHistory.displayName = "SenderManifestToolbarHistory";
